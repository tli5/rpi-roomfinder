    ...
    <div class="panel panel-default col-md-6 col-md-offset-3" role="tabpanel" >
        ...
        <div class="tab-content ">
          ...
          <div role="tabpanel" class="tab-pane fade " id="contact">
            ...
            <!-- <button type="button" data-toggle="modal" data-target="#myModal" id = "contact_image_button">
              <div class="col-md-10 col-md-offset-1" id="contact_image">
                <img src="./images/rpi_autumn.jpg" class="img-responsive img-rounded" alt="Responsive image">
              <div>
            </button> -->
